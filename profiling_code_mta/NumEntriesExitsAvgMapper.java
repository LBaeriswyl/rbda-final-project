...
public class NumEntriesExitsAvgMapper
	extends Mapper<LongWritable, Text, NullWritable, VLongWritableTupleArrayWritable>
{
		...
		throws IOException, InterruptedException
	{
		...
		{
			context.getCounter(NumEntriesExitsAvg.NumEntries.SENTINEL_VALUE).increment(1);
			context.getCounter(NumEntriesExitsAvg.NumExits.SENTINEL_VALUE).increment(1);
			return;
		}
		...
		VLongWritableTuple num_entries_tuple = new VLongWritableTuple(input_num_entries, 1);
		VLongWritableTuple num_exits_tuple = new VLongWritableTuple(input_num_exits, 1);
